...
/* harmony import */ var _shared_popup_popup_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./shared/popup/popup.component */ "./src/app/shared/popup/popup.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _shared_popup_popup_component__WEBPACK_IMPORTED_MODULE_24__["PopupComponent"]
            ],
            imports: [
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_services_general_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/services/general.service */ "./src/app/shared/services/general.service.ts");
/* harmony import */ var _shared_services_popup_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/services/popup.service */ "./src/app/shared/services/popup.service.ts");
...
var BlogComponent = /** @class */ (function () {
    function BlogComponent(data, popup, http) {
        this.data = data;
        this.popup = popup;
        this.http = http;
        this.model = {};
    ...
    BlogComponent.prototype.checkModal = function ($event) {
    ...
    BlogComponent.prototype.getPosts = function () {
        ...
        this.postsData$.subscribe(function (data) {
            console.log(data);
        });
    };
    BlogComponent.prototype.onSearch = function () {
        this.http.post("http://laravel/external/search-posts", this.search_model).subscribe(function (response) {
            console.log(response);
        });
    };
    BlogComponent.prototype.onSubmit = function () {
        var _this = this;
        this.http.post("http://laravel/external/subscribe", this.model).subscribe(function (response) {
            if (Object.keys(response)[0] === 'errors') {
                _this.action = true;
                var message = Object.values(response)[0].toString().split(",").join("\n");
                _this.popup.popupMessage(message);
            }
            else {
                _this.action = true;
                var message = Object.values(response)[0].toString().split(",").join("\n");
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("subscribeForm"),
        __metadata("design:type", Object)
    ], BlogComponent.prototype, "submitForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("searchForm"),
        __metadata("design:type", Object)
    ], BlogComponent.prototype, "searchForm", void 0);
    BlogComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_general_service__WEBPACK_IMPORTED_MODULE_1__["GeneralService"],
            _shared_services_popup_service__WEBPACK_IMPORTED_MODULE_2__["PopupService"],
...
var ContactComponent = /** @class */ (function () {
    function ContactComponent(data, popup, http) {
        this.data = data;
        this.popup = popup;
        this.http = http;
        this.model = {};
    ...
    ContactComponent.prototype.checkModal = function ($event) {
        $event === false ? this.action = false : this.action = true;
    };
    ContactComponent.prototype.onSubmit = function () {
        var _this = this;
        this.http.post("http://askcoder.tech/external/store", this.model).subscribe(function (response) {
            if (Object.keys(response)[0] === 'errors') {
                _this.action = true;
                var message = Object.values(response)[0].toString().split(",").join("\n");
                _this.popup.popupMessage(message);
...
module.exports = "<div class=\"modal\" [class.active]=\"action_value\" (click)=\"closeModal($event)\">\n  <div class=\"modal__window\">\n      <div class=\"modal__headline\">{{popup_message}}</div>\n      <div class=\"modal__cross\" (click)=\"closeModal($event)\">\n          <div class=\"modal__cross-line\"></div>\n          <div class=\"modal__cross-line\"></div>\n      </div>\n  </div>\n</div>"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_popup_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/popup.service */ "./src/app/shared/services/popup.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PopupComponent = /** @class */ (function () {
    function PopupComponent(popup) {
        this.popup = popup;
        this.returnEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"](true);
    }
    PopupComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.popup.currentMessage.subscribe(function (message) { return _this.popup_message = message; });
    };
    PopupComponent.prototype.closeModal = function ($event) {
        var modalElem = $event.target.classList.contains('modal');
        var crossElem = $event.target.classList.contains('modal__cross');
    ...
    ], PopupComponent.prototype, "action_value", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], PopupComponent.prototype, "returnEvent", void 0);
    PopupComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-popup',
            template: __webpack_require__(/*! ./popup.component.html */ "./src/app/shared/popup/popup.component.html"),
            styles: [__webpack_require__(/*! ./popup.component.scss */ "./src/app/shared/popup/popup.component.scss")]
        }),
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"])({ selector: 'button[counting]' }),
        __metadata("design:paramtypes", [_services_popup_service__WEBPACK_IMPORTED_MODULE_1__["PopupService"]])
    ], PopupComponent);
...
var PopupService = /** @class */ (function () {
    ...
    PopupService.prototype.popupMessage = function (message) {
